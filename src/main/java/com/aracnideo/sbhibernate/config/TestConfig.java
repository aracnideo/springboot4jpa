...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2026-02-03T11:00:00Z"), u1);
		Order o2 = new Order(null, Instant.parse("2026-03-03T09:30:00Z"), u1);
		Order o3 = new Order(null, Instant.parse("2026-02-03T10:50:00Z"), u2);
		Order o4 = new Order(null, Instant.parse("2026-02-03T14:15:00Z"), u3);
		Order o5 = new Order(null, Instant.parse("2026-03-03T19:02:00Z"), u3);
